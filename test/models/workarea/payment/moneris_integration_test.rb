...
module Workarea
  class MonerisIntegrationTest < Workarea::TestCase
    include MonerisGatewayVCRConfig

    def test_store_auth
      VCR.use_cassette 'moneris/store_auth' do
    ...
    def test_store_purchase
      VCR.use_cassette 'moneris/store_purchase' do
    ...
    def test_auth_capture
      VCR.use_cassette 'moneris/auth_capture' do
        tender.amount = 5.to_m
        transaction = tender.build_transaction(action: 'authorize')
        operation = Payment::Authorize::CreditCard.new(tender, transaction)
        operation.complete!
    ...
    def test_auth_void
      VCR.use_cassette 'moneris/auth_void' do
        tender.amount = 5.to_m
        transaction = tender.build_transaction(action: 'authorize')
        operation = Payment::Authorize::CreditCard.new(tender, transaction)
        operation.complete!
    ...
    def test_purchase_void
      VCR.use_cassette 'moneris/purchase_void' do
        tender.amount = 5.to_m
        transaction = tender.build_transaction(action: 'purchase')
        operation = Payment::Purchase::CreditCard.new(tender, transaction)
        operation.complete!
    ...
    def test_auth_capture_refund
      VCR.use_cassette 'moneris/auth_capture_refund' do
        tender.amount = 5.to_m
        transaction = tender.build_transaction(action: 'authorize')
        operation = Payment::Authorize::CreditCard.new(tender, transaction)
        operation.complete!
    ...
    def test_purchase_refund
      VCR.use_cassette 'moneris/purchase_refund' do
        tender.amount = 5.to_m
        transaction = tender.build_transaction(action: 'purchase')
        operation = Payment::Purchase::CreditCard.new(tender, transaction)
        operation.complete!
